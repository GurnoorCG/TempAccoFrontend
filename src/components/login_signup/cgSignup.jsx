        ...
        >
          <div className="row" style={{width:"85%"}}>
            <div className="col-12 text-center">
              <img className="img-fluid" src={building} style={{position: "relative",bottom: "4%"}} />
        ...
        >
          <div className="row">
            <div className="col-12 text-center mb-4 mt-5">
              ...
              <h4 className="main-heading mt-3" style={{fontSize:"20px"}}>Let's Find Your Accommodation</h4>
            </div>
          </div>
          <div className="row">
            <div
            ...
            >
              <a>
                <img src={arrow} /> <span className="mail">email@email.com</span> 
              </a>
